...
import { AlertTriangle, CheckCircle2, Clock3, FileDown, ListTodo, Moon, RefreshCw, Sun, Target, TrendingUp } from "lucide-react";
  ...
  return (
    <div className="site-layout">
      ...
      <main className="site-content analytics-shell">
        ...
        <section className="analytics-kpis" aria-busy={loading}>
        ...
        <section className="analytics-grid">
          <ChartCard title="Completion trend" description="Tasks created and completed each day" wide>
